...
import com.example.deliveryapp.databinding.DialogDeniedPermissionBinding

class DeniedPermissionDialog: DialogFragment() {
        ...
        companion object {
            ...
            ): DeniedPermissionDialog = DeniedPermissionDialog().apply {
                this.title = title
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            val binding = DialogDeniedPermissionBinding.inflate(requireActivity().layoutInflater)
        ...
        data class Action(
            val text: String,
            val onClickListener: (DeniedPermissionDialog) -> Unit
        ) {
            companion object {
                val Empty = Action("") {}
            }
