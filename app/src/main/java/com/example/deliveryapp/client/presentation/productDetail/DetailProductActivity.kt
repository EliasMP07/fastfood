                ...
                viewModel.events.collect{event ->
                    when(event){
                        is DetailProductEvent.Error -> {
                            UtilsMessage.showSnackBac(mensaje = event.error.asString(this@DetailProductActivity), this@DetailProductActivity.binding.root)
                        }
                        is DetailProductEvent.Success ->{
                            UtilsMessage.showSnackBac(mensaje = event.message.asString(this@DetailProductActivity), this@DetailProductActivity.binding.root)
                        }
                    }
                }
            }
